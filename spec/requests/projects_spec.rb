...
describe "Projects" do
  describe "show" do
    before :each do
      ...
      @task1 = FactoryGirl.create(:task, :title => "Task1", :body => "Work for task 1")
      @task2 = FactoryGirl.create(:task, :title => "Task2" )
      @project.tasks << @task1
      @project.tasks << @task2
      @email = FactoryGirl.create(:email)
      @project.emails << @email
    end
    it "should show it's title and list of tasks" do
      visit project_path(@project)
      page.should have_content @project.title
      page.should have_link @task1.title
      page.should have_link @task2.title
      click_link @task1.title
      page.should have_content @task1.body
    end
    it "should have a list of files from emails" do
    ...
    it "should have an add task button" do
      visit project_path(@project)
      page.should have_link "Add Task"
      click_link "Add Task"
